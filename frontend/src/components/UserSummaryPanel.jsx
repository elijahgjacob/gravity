...
import { User, RefreshCw, Loader2, TrendingUp, Tag, ChevronDown } from 'lucide-react'
...
export default function UserSummaryPanel({ onSelectUser, searchSuccessWithUserId, refreshTrigger }) {
  ...
  // Refresh profile whenever a query is sent (triggered by parent)
  useEffect(() => {
    if (refreshTrigger && selectedUserId) {
      fetchProfileSummary(selectedUserId)
    }
  }, [refreshTrigger, selectedUserId, fetchProfileSummary])
            ...
            <AccordionItem>
              <AccordionTrigger>
                <div className="flex items-center gap-2">
                  ...
                  <Badge variant="secondary" className="bg-blue-600/20 text-blue-400 border-blue-500/30 text-[10px]">
