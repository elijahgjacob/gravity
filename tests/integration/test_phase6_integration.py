...
class TestPhase6Integration:
    ...
    async def test_basic_ranking_without_context(self, ranking_service, sample_campaigns):
        ...
        ranked = await ranking_service.rank(
            campaigns=sample_campaigns.copy(), query=query, categories=categories, context=None
        )
    ...
    async def test_ranking_with_context(self, ranking_service, sample_campaigns):
        ...
        ranked = await ranking_service.rank(
            campaigns=sample_campaigns.copy(), query=query, categories=categories, context=context
        )
    ...
    async def test_category_boost_exact_match(self, ranking_service):
        ...
        ranked = await ranking_service.rank(
            campaigns=campaigns.copy(), query="shoes", categories=categories, context=None
        )
    ...
    async def test_category_boost_subcategory_match(self, ranking_service):
        ...
        ranked = await ranking_service.rank(
            campaigns=campaigns.copy(), query="running shoes", categories=categories, context=None
        )
    ...
    async def test_age_targeting_boost(self, ranking_service):
        ...
        campaigns = [
            {
                ...
                "subcategories": [],
                "similarity_score": 0.70,
                "targeting": {"age_min": 18, "age_max": 30},
            },
            {
                ...
                "subcategories": [],
                "similarity_score": 0.70,
                "targeting": {"age_min": 50, "age_max": 70},
            },
        ]
        ...
        ranked = await ranking_service.rank(
            campaigns=campaigns.copy(), query="product", categories=["product"], context=context
        )
        ...
        campaigns = [
            {
                ...
                "subcategories": [],
                "similarity_score": 0.70,
                "targeting": {"locations": ["CA", "San Francisco"]},
            },
            {
                "campaign_id": "camp_ny",
                "category": "product",
                "subcategories": [],
                "similarity_score": 0.70,
                "targeting": {"locations": ["NY", "New York"]},
            },
        ]
        ...
        campaigns = [
            {
                ...
                "subcategories": [],
                "similarity_score": 0.70,
                "targeting": {"interests": ["fitness", "running", "health"]},
            },
            {
    ...
    async def test_ranking_empty_campaigns(self, ranking_service):
        ...
        ranked = await ranking_service.rank(
            campaigns=[], query="test", categories=["test"], context=None
        )
    ...
    async def test_ranking_single_campaign(self, ranking_service):
        ...
        ranked = await ranking_service.rank(
            campaigns=campaigns.copy(), query="product", categories=["product"], context=None
        )
    ...
    async def test_ranking_preserves_campaign_data(self, ranking_service, sample_campaigns):
        ...
        ranked = await ranking_service.rank(
            campaigns=sample_campaigns.copy(), query="test", categories=["test"], context=None
        )
    ...
    async def test_ranking_with_missing_targeting_fields(self, ranking_service):
        ...
        context = {"age": 30, "gender": "male", "location": "CA", "interests": ["fitness"]}
    ...
    async def test_ranking_latency_large_batch(self, ranking_service):
        ...
        # Warm-up
        await ranking_service.rank(
            campaigns=campaigns.copy(), query=query, categories=categories, context=context
        )
