...
"""
    ...
    async def test_sensitive_queries_return_low_score(self, eligibility_service):
        ...
        test_cases = [
            ...
            ("I need severe medical help", "Medical emergency - severe"),
            ("I need urgent medical help", "Medical emergency - urgent"),
            ("I need critical medical help", "Medical emergency - critical"),
        ...
        for query, description in test_cases:
            ...
            assert (
                0.3 <= score <= 0.5
            ), f"{description}: '{query}' got score {score}, expected 0.3-0.5"
...
class TestEligibilityServiceRealWorldQueries:
    ...
    async def test_medium_eligibility_queries(self, eligibility_service):
        ...
        for query in medium_eligibility_queries:
            ...
            assert (
                0.7 <= score <= 0.85
            ), f"Query '{query}' should have medium eligibility, got {score}"
